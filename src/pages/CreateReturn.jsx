...
const CreateReturn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const filePath = `devoluciones/${fileName}`;
    ...
    <div style={{ width: '100%', padding: '0 1rem', paddingBottom: '3rem' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1.5rem' }}>
        <div style={{ background: '#f0f9ff', padding: '8px', borderRadius: '8px' }}>
            <Undo2 size={28} color="#0284c7" />
        </div>
        <div>
            <h1 style={{ fontSize: '1.5rem' }}>Nueva Devolución</h1>
            <p className="text-sm">Reingreso de mercancía por cliente.</p>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '1.5rem', alignItems: 'stretch' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div className="card">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
                        <div>
                            ...
                            <input required name="folio" type="text" className="form-input" placeholder="Ej: F-99887" onChange={handleInputChange} />
                        </div>
                        <div>
                ...
                <div className="card" style={{ flex: 1 }}>
                    ...
                    <div>
                         <label className="form-label">Razón de Devolución</label>
                         <textarea required name="razon_devolucion" className="form-input" rows="5" placeholder="Motivo del reingreso..." onChange={handleInputChange} style={{ resize: 'none' }}></textarea>
                    </div>
                </div>
            </div>
